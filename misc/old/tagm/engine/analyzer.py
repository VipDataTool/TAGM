...
from misc.old.tagm.engine.result import (
...
class Analyzer:
    ...
    def _compute_ltp(self, logits, tokens, input_ids,
        ...
        """
        from misc.old.tagm.engine.ltp import compute_ltp
        return compute_ltp(
    ...
    def _compute_sfd(self, seq_len: int) -> Optional[SFDResult]:
        ...
        from misc.old.tagm.engine.sfd import compute_sfd, precompute_sfd_cache
    ...
    def _compute_rank_displacement(self, result: PromptResult):
        ...
        from misc.old.tagm.engine.sfd import compute_rank_displacement
        try:
