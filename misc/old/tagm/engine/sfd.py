...
def compute_sfd(layer_acts: dict, cache: dict):
    ...
    """
    from misc.old.tagm.engine.result import SFDResult
...
def compute_rank_displacement(instruct_cf, base_cf):
    ...
    for pos in range(n_pos):
        ...
        inst = {t: (rank, prob) for rank, (t, prob) in enumerate(i_alts)}
        base = {t: (rank, prob) for rank, (t, prob) in enumerate(b_alts)}
