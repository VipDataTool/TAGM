...
from misc.old.tagm.core.adapter.registry import find_adapter
from misc.old.tagm.core.deltas.compute import compute_deltas_from_disk
from misc.old.tagm.core.deltas.spectral import compute_spectral_profile
...
if TYPE_CHECKING:
    ...
    from misc.old.tagm.core.deltas.store import DeltaStore
...
class Pipeline:
    ...
    def load(
        ...
        if delta_backend == "mmap":
            from misc.old.tagm.core.deltas.store import MmapDeltaStore, DeltaStoreMetadata
