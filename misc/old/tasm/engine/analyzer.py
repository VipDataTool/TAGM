...
from misc.old.tasm.engine.ltp import (LTPResult, compute_ltp, ltp_result_to_dict,
                        precompute_svd_cache)
from misc.old.tasm.engine.sfd import (SFDResult, SFDCache, precompute_sfd_cache,
...
class Analyzer:
    ...
    def _compute_ltp(self, logits, tokens, input_ids,
        ...
        from misc.old.tasm.engine.ltp import compute_ltp as _compute_ltp
