...
class AnalysisModule(ABC):
    ...
    def metadata(self) -> dict:
        return {
            ...
            "min_results": getattr(self, "min_results", 1),
            "requires_sfd": "spectral_field_density" in self.depends_on_measurements,
            "requires_ltp": "lateral_tension_profile" in self.depends_on_measurements,
            "requires_rd": "rank_displacement" in self.depends_on_measurements,
        }
