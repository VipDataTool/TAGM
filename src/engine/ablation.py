...
class AblationRunner:
    ...
    def _generate_with_specs(self, specs: list[InterventionSpec],
        ...
        # Hold the model lock for the WHOLE intervened phase: the hooks
        # live on the shared model, so any concurrent forward (analysis,
        # chat) would silently run with the ablation applied.
        with MODEL_LOCK:
